...
class AgentManagerTests(unittest.TestCase):
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            try:
                ...
                connection.executemany(
                    ...
                    [
                        ("a1", "s1", "job51", "运营B", "hash-1", "parsed", "2026-07-16T00:02:00+00:00"),
                        ("a2", "s1", "job51", "运营B", "hash-2", "pending", "2026-07-16T00:03:00+00:00"),
                        ("a3", "s1", "job51", "运营B", "hash-2", "pending", "2026-07-16T00:04:00+00:00"),
                        ("a4", "s1", "boss", "运营B", "boss-hash", "pending", "2026-07-16T00:04:30+00:00"),
                    ],
                )
                connection.execute(
    ...
    def test_skill_documents_job51_delayed_export_dialog_contract(self) -> None:
        root = Path(__file__).resolve().parents[1]
        runbook = (root / "references" / "operations-runbook.md").read_text(
            encoding="utf-8"
        )
        contracts = (root / "references" / "platform-contracts.md").read_text(
            encoding="utf-8"
        )
        ...
        self.assertIn("request an attachment", contracts)
        self.assertIn("never navigate to export records", contracts.lower())
